        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div style="background-color: #572a08;" class="p-5 rounded-xl border border-amber-900/20 shadow-lg">
                    ...
                    <p class="text-3xl font-extrabold text-white mt-1">PKR <?php echo e(number_format($expenses->sum('amount'), 2)); ?></p>
                </div>

                <!-- This Month Card -->
               <div style="background-color: #572a08;" class="p-5 rounded-xl border border-amber-900/20 shadow-lg">
                    <p class="text-sm font-semibold text-amber-300/70 uppercase tracking-wider">This Month</p>
                    <p class="text-3xl font-extrabold text-white mt-1"><?php echo e($expenses->count()); ?> items</p>
                </div>
                ...
                <div style="background-color: #572a08;" class="p-5 rounded-xl border border-amber-900/20 shadow-lg">
                    ...
                    <p class="text-3xl font-extrabold text-white mt-1">
                        <?php echo e($expenses->groupBy('category')->map->sum('amount')->sortDesc()->keys()->first() ?? 'None'); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
                ...
                <div style="background-color: #572a08;" class="rounded-xl shadow-xl border border-amber-900/20 overflow-hidden h-fit">
                   <div style="background-color: #a14d0f;" class="px-6 py-4">
                    ...
                    <form action="<?php echo e(route('expenses.store')); ?>" method="POST" class="p-6 space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="date" name="expense_date" required value="<?php echo e(date('Y-m-d')); ?>" style="background-color: #3d1f07;" class="w-full rounded-xl border-amber-800/30 text-white shadow-inner focus:border-amber-400 focus:ring-amber-400 font-medium text-sm">
                        </div>
                            ...
                            <tbody class="divide-y divide-amber-900/20 text-sm">
                                <?php $__empty_1 = true; $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-amber-950/20 transition duration-100">
                                        <td class="p-4">
                                            <div class="font-bold text-white text-base"><?php echo e($expense->title); ?></div>
                                            <?php if($expense->description): ?>
                                                <div class="text-xs text-amber-300/50 mt-0.5 font-medium"><?php echo e($expense->description); ?></div>
                                            <?php endif; ?>
                                        </td>
                                        <td class="p-4">
                                        ...
                                        <td class="p-4 font-extrabold text-white text-base">
                                            PKR <?php echo e(number_format($expense->amount, 2)); ?>
                                        ...
                                        <td class="p-4 text-center">
                                            <form action="<?php echo e(route('expenses.destroy', $expense->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?')">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\expense-tracker\resources\views/dashboard.blade.php ENDPATH**/ ?>